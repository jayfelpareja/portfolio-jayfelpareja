...
export default function Hero() {
    ...
    const handleTriggerBuild = () => {
        ...
        // FIRED IMMEDIATELY HERE TO PREVENT MOBILE POP-UP BLOCKERS FROM KILLING IT
        ...
        // Simulates processing loading latency for a few seconds for visual aesthetic
        setTimeout(() => {
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12 items-start">
                ...
                <div className="md:col-span-2 space-y-6">
                    ...
                    <h1 className="text-3xl sm:text-4xl md:text-6xl font-bold tracking-tight leading-tight text-foreground">
                        Design That Works.<br />Not Just Looks.
                    </h1>
